...
config_path = "yoloV4_tomato/yolov4-tiny-obj.cfg"
weights_path = "yoloV4_tomato/yolov4-tiny-obj_last.weights"
labels = open("yoloV4_tomato/obj.names").read().strip().split("\n")
